		...
		<Container>
			...
			{popup["description"] && (
				...
				: "Podczas tworzenia tego projektu trudność polegała na wymyśleniu designu. Wolę pracować nad projektami" +
						...
						" rozczarowany interfejsem API, ponieważ nie pozwala on udostępniać aplikacji na stronach gh, a nie miałem czasu szukać lepszego zamiennika. A jeśli chodzi o zabawę to cały projekt dał mi dużo satysfakcji, cieszę się że mogłem spróbować swoich sił pod presją czasu."}
				/>)}
		</Container>
	);
};
